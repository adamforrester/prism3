...
<!-- What we don't know, and what we'd do differently depending on the answer. -->

## What we already know

<!-- Current state per surface — web / Figma / MCP / code — so the investigation starts
     from the edge of our knowledge rather than the beginning. -->
...
<!-- The artifact that closes this: a doc section, a decision issue opened, a working
     spike with a named verdict. Not "we looked into it." -->
