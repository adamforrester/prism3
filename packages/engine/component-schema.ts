...
export const figmaPropertyErrors = (def: ComponentDef): string[] => {
  ...
  // AND THE COMPLEMENT, which the rule above cannot see (#796): every `text` part must BE claimed by one
  ...
  // `field-label`'s indicator as a blank node through a green suite.
  //
