 ...
 * regression) into a real measurement. Run:  npx tsx packages/engine/nb-regression.ts
 *
...
p('');
p(`Generated by \`packages/engine/nb-regression.ts\`. Engine L defaults: lMax=0.975, lMin=0.16.`);
