 ...
 *
 * 0.167.0 — #1670: the Spinner component, to the owner's spec (2026-09-26), and the button's pending state
 ...
 * (its grid only grows; no existing alias moves). Compact is left alone: it is a corpus density (aurora),
