 ...
 *
 * 0.23.0: every projected TEXT node now CLAIMS its vertical alignment (#1009 half 2). A new
 ...
 * Figma variables do not multiply, so no px line-height variable exists to bind one to. (#1009)
