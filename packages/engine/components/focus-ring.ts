 ...
 *  4. PAINT WOULD NOT BIND ANYWAY. `paintOf` keys every lookup as `{intent}.{appearance}.{slot}`
 *     (`anatomy-figma.ts`), so a def whose paint axis is `color` resolves no paint at all — #758.
 *
