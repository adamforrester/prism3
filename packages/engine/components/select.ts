...
export const select: ComponentDef = {
  ...
  tokens: {
    ...
    // focus-visible members are the EMPTY control at each interaction, so they show the placeholder in
    // `text.secondary`; `filled` takes the bare `label`, `text.primary`.
