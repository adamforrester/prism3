...
| interactive.primary.on-fill | black | 5.45 | 4.5 | ✅ |
...
| interactive.destructive.on-fill | black | 5.45 | 4.5 | ✅ |
...
| foreground.inverse.secondary | neutral.850 | — | — | · |
| foreground.inverse.tertiary | neutral.800 | — | — | · |
| foreground.brand | primary.550 | 4.64 | 3 | ✅ |
| foreground.success | success.500 | 3.32 | 3 | ✅ |
| foreground.warning | warning.500 | 3.32 | 3 | ✅ |
...
| foreground.info-subtle | info.100 | — | — | · |
| foreground.danger | danger.500 | 3.30 | 3 | ✅ |
| interactive.primary.fill.rest | accent.500 | 3.30 | 3 | ✅ |
| interactive.primary.fill.hover | accent.550 | 4.12 | 3 | ✅ |
| interactive.primary.fill.pressed | accent.600 | 4.95 | 3 | ✅ |
| interactive.primary.fill.focused | accent.550 | 4.12 | 3 | ✅ |
| interactive.primary.fill.selected | accent.600 | 4.95 | 3 | ✅ |
...
| interactive.destructive.fill.rest | danger.500 | 3.30 | 3 | ✅ |
| interactive.destructive.fill.hover | danger.550 | 4.02 | 3 | ✅ |
| interactive.destructive.fill.pressed | danger.600 | 4.89 | 3 | ✅ |
| interactive.destructive.fill.focused | danger.550 | 4.02 | 3 | ✅ |
| interactive.destructive.fill.selected | danger.600 | 4.89 | 3 | ✅ |
...
| border.focus | accent.500 | 3.76 | 3 | ✅ |
...
| border.info | info.500 | 4.56 | 4.5 | ✅ |
| border.focus | accent.600 | 6.85 | 4.5 | ✅ |
...
| interactive.primary.on-fill | black | 6.27 | 4.5 | ✅ |
...
| interactive.destructive.on-fill | black | 5.35 | 4.5 | ✅ |
...
| border.info | info.500 | 4.61 | 4.5 | ✅ |
| border.focus | accent.400 | 6.27 | 4.5 | ✅ |
...
| border.info | info.500 | 4.56 | 4.5 | ✅ |
| border.focus | primary.600 | 6.79 | 4.5 | ✅ |
...
| interactive.primary.on-fill | black | 5.41 | 4.5 | ✅ |
...
| text.danger-subtle | danger.350 | — | — | · |
| text.info-subtle | info.350 | — | — | · |
| text.on-brand | black | 5.41 | 4.5 | ✅ |
| text.on-success | black | 5.47 | 4.5 | ✅ |
| text.on-warning | black | 5.42 | 4.5 | ✅ |
| text.on-danger | black | 5.35 | 4.5 | ✅ |
| text.on-info | black | 5.43 | 4.5 | ✅ |
| text.on-inverse | black | 21.00 | 7 | ✅ |
...
| icon.danger-subtle | danger.350 | — | — | · |
| icon.info-subtle | info.350 | — | — | · |
| icon.on-brand | black | 5.41 | 4.5 | ✅ |
| icon.on-success | black | 5.47 | 4.5 | ✅ |
| icon.on-warning | black | 5.42 | 4.5 | ✅ |
| icon.on-danger | black | 5.35 | 4.5 | ✅ |
| icon.on-info | black | 5.43 | 4.5 | ✅ |
| icon.on-inverse | black | 21.00 | 7 | ✅ |
...
| border.danger | danger.500 | 4.60 | 4.5 | ✅ |
| border.info | info.500 | 4.61 | 4.5 | ✅ |
| border.focus | primary.450 | 5.41 | 4.5 | ✅ |
